    ...
    return (
        <div className="p-12">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="relative mb-4 w-full">
                    <label htmlFor="summary" className="leading-7 text-sm text-gray-600 capitalize">
                ...
                <div className="my-6">
                    <label htmlFor="category" className="leading-7 text-sm text-gray-600 capitalize">For Proper Full Insight Page</label>
                    <ReactQuill
                        theme="snow"
                        value={content}
