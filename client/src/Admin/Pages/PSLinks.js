...
function PSLinks() {
    ...
    const pageUrl = formData.category && formData.pageLinkName
        ? `https://moja-solution.vercel.app/${formData.category.toLowerCase().replace(/\s+/g, '-')}/${formData.pageLinkName.toLowerCase().replace(/\s+/g, '-')}`
        : '';
    ...
    const handleSubmit = async (e) => {
        ...
        const linkURL = `${formData.category.toLowerCase().replace(/\s+/g, '-')}/${formData.pageLinkName.toLowerCase().replace(/\s+/g, '-')}`;
        ...
        <div className="p-12">
            ...
            <form onSubmit={handleSubmit}>
                <div className="flex items-center justify-center space-x-8 w-full mt-8">
                    ...
                    <div className="relative mb-4 w-full">
                        <label htmlFor="pageLinkName" className="leading-7 text-sm text-gray-600">Page Link Name</label>
                        <input
                            id="pageLinkName"
                            name="pageLinkName"
                            type="text"
                ...
                <div className="relative mb-4 w-full">
                    <label htmlFor="overview" className="leading-7 text-sm text-gray-600">Overview</label>
                    <textarea
                        id="overview"
                        name="overview"
